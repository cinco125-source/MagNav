...
establishes the observability condition. Section~\ref{sec:results} describes the
...
marginalized particle filter carrying the TL coefficients; all numbers are our own
runs under one protocol.
