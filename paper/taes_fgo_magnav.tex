...
and never returns; with the compensation prior raised to $\sigma_{eta}=100$, and nothing else
...
With the compensation prior raised to $\sigma_{eta}=100$, the per-epoch smoother runs
