...
learned component of its own, it beats a tuned EKF+TL+NN baseline. A Monte-Carlo
simulation confirms the reported covariance is consistent, and an independent GTSAM
...
segment \SI{17.5}{} against \SI{21.4}{\meter}, the GTSAM side being slightly the better of
