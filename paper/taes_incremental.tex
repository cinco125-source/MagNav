...
how good the newest state is, so across this sweep the accuracy bought by
look-ahead is smoothing gain to within a metre, and a designer who cannot
afford latency loses essentially the gap between the two columns.
