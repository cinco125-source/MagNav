...
length and by \SI{300}{\second} reaches \SIrange{6.7}{19.3}{\meter}, the
scale of the measured smoothed error, so past the knee separability is no
longer the binding constraint and the residual error is set by map error,
inertial noise, and coefficient drift, which more look-ahead does not remove. The
