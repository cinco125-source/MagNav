...
\begin{enumerate}
  ...
  \item \textbf{Flight-data validation.} On uncompensated cabin magnetometers
        ...
        reproduced and tuned for the cold start, yet the smoother beats it
        with no learned component; an ablation over every element of the
        configuration finds metre-level sensitivity to the modelling
        parameters, and the expected sensitivity to excessive numerical
        regularization.
  \item \textbf{A separability condition and a flight-dependent lag metric.}
        ...
        horizontal position from the compensation subspace that does not
        ...
        information metric that we evaluate against the measured lag sweep.
\end{enumerate}
