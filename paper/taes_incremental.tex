...
\caption{Line 1007.06 Mag~4: (a) flown line with the zoom window; (b) late in the line, where the free-inertial drift peaks near \SI{430}{\meter}, every aided path still holds the truth.}
\label{fig:track}
\end{figure}
...
state cadence down to the raw sensor rate.
