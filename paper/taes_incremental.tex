...
\begin{enumerate}
  ...
  \item \textbf{Flight-data validation against reproduced baselines.} On
        ...
        both with no learned component. Because a fixed-lag smoother produces
...
\num{1.5} to \num{5.2}. Read causally, the proposed estimator is the best causal method on
...
case. This is the behaviour Section~\ref{sec:incremental} anticipates, and it
...
so across this sweep the accuracy bought by look-ahead is smoothing gain to
...
process-noise floor produces a larger degradation. The compensation prior may
...
\num{1.5} to \num{5.2} relative to the best causal baseline. The lag sweep locates the design knee
